...
<link href="./../view/fonts/fontawesome/css/all.min.css" type="text/css" rel="stylesheet" />
  ...
  <body>
    ...
    <section class="py-5 sm:py-7 bg-blue-100">
      <div class="container max-w-screen-xl mx-auto px-4">
        <!-- breadcrumbs start -->
        <h2 class="text-3xl font-semibold mb-2">Wish List</h2>
        <!-- <ol
    ...
    <section class="py-12">
      <div class="container max-w-screen-xl mx-auto px-4">
        <div class="flex flex-col md:flex-row -mx-4">
          ...
          <!-- col.// -->
          <main class="md:w-full lg:w-full px-4">
            <div
              ...
              <div>
                ...
                >
                  ...
                  <form class='inline-block' action="http://localhost/fill-rouge/user/WishProduct" method="POST">
                    ...
                    <input type="hidden" name="current_page" value='<?php echo 'WishedProducts' ?>'>
                    <button
                      type='submit'
