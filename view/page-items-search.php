	...
	<section class="py-12">
		<div class="container max-w-screen-xl mx-auto px-4">
			...
			<div class="flex flex-col md:flex-row -mx-4">
				<main class="md:w-2/3 lg:w-full px-3">
							...
							<div class="flex flex-col md:flex-row">
								<div class="md:w-1/4">
									<a href="http://localhost/fill-rouge/user/details/<?php echo $product['id'] ?>">
										<img class="mx-auto w-4/6" src="../view/uploads/<?php echo $product['first_img'] ?>" alt="<?php echo $product['first_img'] ?>">
									</a>
								</div> <!-- col.// -->
								<div class="md:w-2/4">
									<div class="p-4">
            ...
            >
								...
								<div class="md:w-1/4 border-t lg:border-t-0 lg:border-l border-gray-200">
									<div class="p-5">
										...
										<div class="my-3">
											<a class="px-4 py-2 inline-block text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700" href="http://localhost/fill-rouge/user/details/<?php echo $product['id'] ?>"> Buy now </a>
											<?php if(isset($_SESSION['user'])) { ?>
                  ...
                  <form class='inline-block' action="http://localhost/fill-rouge/user/WishProduct" method="POST">
                    ...
                    <input type="hidden" name="current_page" value='<?php echo 'search' ?>'>
                    <button
                      type='submit'
